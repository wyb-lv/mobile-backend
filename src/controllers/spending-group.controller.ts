...
export const spendingGroupController = {
    ...
    async createSpendingGroup(req: AuthedRequest, res: Response) {
        ...
        const data = await spendingGroupService.createSpendingGroup(req.accessToken!, req.userId!, { name, description })
    ...
    async updateSpendingGroup(req: AuthedRequest, res: Response) {
        ...
        const { name, description } = req.body
        const data = await spendingGroupService.updateSpendingGroup(req.accessToken!, req.userId!, id, { name, description })

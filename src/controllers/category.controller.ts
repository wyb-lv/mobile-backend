...
export const categoryController = {
    ...
    async createCategory(req: AuthedRequest, res: Response) {
        ...
        const data = await categoryService.createCategory(req.accessToken!, req.userId!, { name, icon })
    ...
    async updateCategory(req: AuthedRequest, res: Response) {
        ...
        const { name, icon } = req.body
        const data = await categoryService.updateCategory(req.accessToken!, req.userId!, id, { name, icon })
